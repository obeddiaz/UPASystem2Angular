...
UPapp.controller('Modal_success_message', function ($scope, $modalInstance, custom_data, $rootScope) {
    $scope.data_modal = custom_data;
    $scope.isBusy = false;
    $scope.return_data = [];
    $scope.$on('custom_response', function (event, args) {
...
UPapp.controller('Modal_Confirmation_message', function ($scope, $modalInstance, custom_data, $rootScope) {
    $scope.data_modal = custom_data;
    $scope.isBusy = false;
    $scope.return_data = [];
    $scope.$on('custom_response', function (event, args) {
